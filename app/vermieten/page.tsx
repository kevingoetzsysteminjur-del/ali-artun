      ...
      <main>
        ...
        <section style={{ background: "linear-gradient(135deg,#1A3040 0%,#0d1f29 100%)", padding: "120px 0 80px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", position: "relative" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "16px" }}>VERMIETUNG</p>
            <h1 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(2.5rem, 5vw, 4.5rem)", color: "#FFFFFF", lineHeight: 1.1, marginBottom: "24px", maxWidth: "640px" }}>
              Immobilie vermieten <span style={{ color: "#BFA36D" }}>mit Plan A.</span>
            </h1>
        ...
        <section style={{ backgroundColor: "#FEFDFB", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>WAS WIR ÜBERNEHMEN</p>
            <h2 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(1.8rem, 3vw, 2.5rem)", color: "#1C1917", marginBottom: "48px" }}>Unsere Vermietungs-Leistungen</h2>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }} className="vm-grid">
              {leistungen.map((l, i) => (
                <div key={i} style={{ backgroundColor: "#F5F1EC", borderRadius: "16px", padding: "32px", border: "1px solid #E8E0D8" }}>
                  <div style={{ fontSize: "28px", marginBottom: "16px" }}>{l.icon}</div>
                  <h3 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.1rem", color: "#1C1917", marginBottom: "10px" }}>{l.title}</h3>
                  <p style={{ fontSize: "14px", color: "#78716C", lineHeight: 1.75, fontWeight: 300, margin: 0 }}>{l.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ backgroundColor: "#F5F1EC", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(1.8rem, 3vw, 2.5rem)", color: "#1C1917", marginBottom: "40px" }}>Für welche Objekte?</h2>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "16px" }}>
              {objektarten.map((o) => (
                <div key={o.label} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "20px 36px", backgroundColor: "#FEFDFB", border: "1px solid #E8E0D8", borderRadius: "12px", fontSize: "16px", color: "#1C1917", fontWeight: 400 }}>
        ...
        <section style={{ backgroundColor: "#1A3040", padding: "80px 0" }}>
          <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 24px", textAlign: "center" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "20px" }}>UNSER ANSATZ</p>
