  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Hero */}
        <section style={{ background: "linear-gradient(135deg,#1A3040 0%,#0e2230 100%)", padding: "120px 0 80px", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", inset: 0, opacity: 0.05 }}>
            <div style={{ position: "absolute", top: "-10%", right: "-5%", width: "600px", height: "600px", borderRadius: "50%", border: "1px solid #BFA36D" }} />
          </div>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", position: "relative" }}>
            ...
            <h1 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(2.5rem, 5vw, 4.5rem)", color: "#FFFFFF", lineHeight: 1.1, marginBottom: "24px", maxWidth: "700px" }}>
              Immobilienverkauf{" "}<span style={{ color: "#BFA36D" }}>mit Strategie.</span>
            </h1>
        ...
        {/* Unser Rat */}
        <section style={{ backgroundColor: "#F5F1EC", padding: "48px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <div style={{ backgroundColor: "#fff", borderRadius: "16px", padding: "32px 36px", borderLeft: "4px solid #BFA36D", display: "flex", alignItems: "flex-start", gap: "20px" }}>
              <svg width="28" height="28" fill="none" stroke="#BFA36D" strokeWidth="1.5" viewBox="0 0 24 24" style={{ flexShrink: 0, marginTop: "4px" }}>
                <circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/>
              </svg>
              <div>
                <p style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.1rem", color: "#1A3040", marginBottom: "6px" }}>Unser Rat</p>
        ...
        <section style={{ backgroundColor: "#FFFFFF", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>LEISTUNGEN</p>
          ...
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }} className="aufb-grid">
              <div>
                ...
                <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>OBJEKT-AUFBEREITUNG</p>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "32px" }}>
                  {["Home Staging & Einrichtungsberatung", "Professionelle Immobilienfotografie", "Virtuelle Rundgänge (3D)", "Hochwertiges digitales Exposé"].map((b) => (
                    <div key={b} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "14px", color: "#374151", fontWeight: 300 }}>
                      <span style={{ width: "20px", height: "20px", borderRadius: "50%", backgroundColor: "#BFA36D", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        ...
        {/* Käuferfinder */}
        <section id="kaeufer" style={{ backgroundColor: "#F5F1EC", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "start" }} className="kauf-grid">
              <div>
                <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>KÄUFERFINDER</p>
                ...
                <div style={{ width: "48px", height: "2px", backgroundColor: "#BFA36D", margin: "16px 0 24px" }} />
              ...
              <div>
                <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>UNSERE VERMARKTUNGSSTRATEGIE</p>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  {[
                    ...
                    <div key={s} style={{ display: "flex", alignItems: "center", gap: "16px", padding: "14px 20px", backgroundColor: "#fff", borderRadius: "10px", border: "1px solid #E5E7EB" }}>
                      <span style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.1rem", color: "#BFA36D", minWidth: "28px" }}>0{i + 1}</span>
        ...
        <section id="energieausweis" style={{ backgroundColor: "#FFFFFF", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <div style={{ backgroundColor: "#F5F1EC", borderRadius: "20px", padding: "48px", display: "grid", gridTemplateColumns: "1fr auto", gap: "40px", alignItems: "center" }} className="ener-grid">
              <div>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "5px 14px", backgroundColor: "rgba(200,169,110,0.1)", borderRadius: "50px", marginBottom: "16px", border: "1px solid rgba(200,169,110,0.2)" }}>
                  <svg width="14" height="14" fill="none" stroke="#BFA36D" strokeWidth="2" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
                  <span style={{ fontSize: "11px", fontWeight: 500, color: "#BFA36D", letterSpacing: "0.1em" }}>ENERGIEAUSWEIS SERVICE</span>
                </div>
