      ...
      <main className="pt-20">
        ...
        >
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-8 relative text-center">
            <p className="text-[#C5A028] text-sm font-semibold tracking-[0.2em] uppercase mb-5">Baufinanzierung</p>
            ...
            <p className="text-stone-300 text-xl lg:text-2xl leading-relaxed max-w-2xl mx-auto mb-10">
              Verbunden mit über 300 Banken – unabhängig und auf Ihrer Seite
            </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={stat.label}
                  className="text-center py-8 px-6 bg-white rounded-2xl shadow-sm border border-stone-100"
                >
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {features.map((f) => (
                <div
                  key={f.title}
                  className="flex items-start gap-5 bg-[#FAF8F4] rounded-2xl p-7 border border-stone-100 hover:border-[#C5A028]/30 hover:-translate-y-1 transition-all duration-200"
                >
                  <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {processSteps.map((step, i) => (
                <div key={step.num} className="relative">
                  ...
                  <div className="bg-white rounded-2xl p-8 border border-stone-100 text-center hover:-translate-y-1 transition-transform duration-200">
                    <div
