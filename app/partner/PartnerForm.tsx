...
export default function PartnerForm() {
  ...
  if (sent) return (
    <div style={{ padding: "48px", backgroundColor: "#F7F5F2", borderRadius: "16px", textAlign: "center" }}>
      ...
      <p style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.3rem", color: "#1A1A1A", marginBottom: "8px" }}>Anfrage eingegangen!</p>
      <p style={{ fontSize: "14px", color: "#6B7280", fontWeight: 300 }}>Wir melden uns persönlich bei Ihnen.</p>
    </div>
  );
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <button type="submit"
        style={{ padding: "15px", backgroundColor: "#1B3A4B", color: "#fff", border: "none", borderRadius: "50px", fontSize: "14px", fontWeight: 500, cursor: "pointer", transition: "background 0.25s" }}
