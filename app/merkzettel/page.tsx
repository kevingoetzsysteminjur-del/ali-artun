      ...
      <main>
        <section style={{ background: "linear-gradient(135deg,#2C1A0E 0%,#1A0E05 100%)", padding: "120px 0 80px" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#D4A017", marginBottom: "16px" }}>GESPEICHERT</p>
        ...
        <section style={{ backgroundColor: "#F5EDE0", padding: "80px 0", minHeight: "50vh" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            {saved.length === 0 ? (
              <div style={{ textAlign: "center", padding: "80px 24px" }}>
                <svg width="64" height="64" fill="none" stroke="#E8D9C5" strokeWidth="1" viewBox="0 0 24 24" style={{ marginBottom: "24px" }}>
                  <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>
                </svg>
                <h2 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.6rem", color: "#2C1A0E", marginBottom: "12px" }}>Noch keine Immobilien gespeichert</h2>
                <p style={{ fontSize: "14px", color: "#7A6548", fontWeight: 300, marginBottom: "32px" }}>Klicken Sie auf das Herz-Symbol bei einer Immobilie, um sie zu speichern.</p>
                <Link href="/#angebote"
                  style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "14px 32px", backgroundColor: "#2C1A0E", color: "#fff", borderRadius: "50px", textDecoration: "none", fontSize: "14px", fontWeight: 500 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "24px" }} className="merk-grid">
                {saved.map(p => (
                  <div key={p.id} style={{ backgroundColor: "#fff", borderRadius: "16px", overflow: "hidden", border: "1px solid #E8D9C5" }}>
                    <div style={{ height: "180px", background: "linear-gradient(135deg,#2C1A0E,#1A0E05)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
                    ...
                    <div style={{ padding: "20px" }}>
                      <span style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "#D4A017" }}>{p.typ}</span>
                      <h3 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.1rem", color: "#2C1A0E", margin: "8px 0 4px" }}>{p.titel}</h3>
                      <p style={{ fontSize: "13px", color: "#A89070", margin: "0 0 12px", fontWeight: 300 }}>{p.ort}</p>
                      <p style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.2rem", color: "#2C1A0E", margin: 0 }}>{p.preis}</p>
                      <Link href="/verkaufen"
                        style={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: "16px", padding: "10px 20px", backgroundColor: "#2C1A0E", color: "#fff", borderRadius: "50px", textDecoration: "none", fontSize: "13px", fontWeight: 500 }}>
                        Anfrage senden →
                      </Link>
                    </div>
                  </div>
