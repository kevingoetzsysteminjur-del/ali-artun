  ...
  return (
    <>
      <style>{`
        ...
        .hero-btn-primary { display:inline-flex;align-items:center;gap:8px;padding:16px 36px;background:linear-gradient(135deg,#1A3040,#243E4F);color:#fff;border-radius:60px;text-decoration:none;font-size:13px;font-weight:500;letter-spacing:0.05em;text-transform:uppercase;box-shadow:0 4px 20px rgba(27,58,75,0.3);transition:all 400ms cubic-bezier(0.4,0,0.2,1); }
        .hero-btn-primary:hover { background:linear-gradient(135deg,#BFA36D,#D4B87E);transform:scale(1.03); }
        .hero-btn-secondary { display:inline-flex;align-items:center;gap:8px;padding:16px 36px;background:transparent;color:#fff;border-radius:60px;text-decoration:none;font-size:13px;font-weight:500;letter-spacing:0.05em;text-transform:uppercase;border:1.5px solid rgba(255,255,255,0.45);transition:all 400ms cubic-bezier(0.4,0,0.2,1); }
        .hero-btn-secondary:hover { border-color:#BFA36D;color:#BFA36D; }
        .svc-card { background:#FEFDFB;border:1px solid #E8E0D8;border-radius:20px;padding:40px;display:flex;flex-direction:column;gap:20px;height:100%;box-sizing:border-box;transition:all 0.3s ease;cursor:pointer;text-decoration:none;color:inherit; }
        .svc-card:hover { box-shadow:0 16px 48px rgba(28,25,23,0.1);transform:translateY(-4px);border-color:#BFA36D; }
        .cta-btn { display:inline-flex;align-items:center;gap:8px;padding:16px 36px;background:linear-gradient(135deg,#1A3040,#243E4F);color:#fff;border-radius:60px;text-decoration:none;font-size:13px;font-weight:500;letter-spacing:0.05em;text-transform:uppercase;box-shadow:0 4px 20px rgba(27,58,75,0.2);transition:all 400ms cubic-bezier(0.4,0,0.2,1); }
        .cta-btn:hover { background:linear-gradient(135deg,#BFA36D,#D4B87E);transform:scale(1.03); }
        .cta-btn-outline { display:inline-flex;align-items:center;gap:8px;padding:16px 36px;background:transparent;color:#BFA36D;border-radius:60px;text-decoration:none;font-size:13px;font-weight:500;letter-spacing:0.05em;text-transform:uppercase;border:1.5px solid #BFA36D;transition:all 400ms cubic-bezier(0.4,0,0.2,1); }
        .cta-btn-outline:hover { background:#BFA36D;color:#fff; }
      ...
      <section style={{ position: "relative", height: "100svh", minHeight: "620px", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "0 24px", maxWidth: "860px" }} className="rv">
          ...
          <h1 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(2.4rem, 6vw, 4.8rem)", color: "#FFFFFF", lineHeight: 1.1, marginBottom: "24px", fontWeight: 400 }}>
            ...
            <em style={{ color: "#BFA36D", fontStyle: "italic" }}>geprüfter Käuferfinanzierung.</em>
          </h1>
      ...
      {/* ══ 2. VERTRAUEN-LEISTE ═══════════════════════════════════ */}
      <section style={{ backgroundColor: "#1A3040" }}>
      ...
      {/* ══ 3. SERVICE CARDS ══════════════════════════════════════ */}
      <section style={{ backgroundColor: "#FEFDFB", padding: "96px 0" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          <div className="rv" style={{ textAlign: "center", marginBottom: "56px" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>UNSERE LEISTUNGEN</p>
            <h2 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(2rem, 3.5vw, 3rem)", color: "#1C1917", lineHeight: 1.2, margin: 0 }}>Was Plan A für Sie tut.</h2>
            <div style={{ width: "48px", height: "2px", backgroundColor: "#BFA36D", margin: "20px auto 0" }} />
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }} className="svc-grid">
            {[
              ...
              <Link key={card.href} href={card.href} className={`rv rv-d${i + 1} svc-card`}>
                <div style={{ width: "64px", height: "64px", borderRadius: "16px", backgroundColor: "#F5F1EC", display: "flex", alignItems: "center", justifyContent: "center", color: "#1A3040" }}>
                  {card.icon}
                </div>
                <div style={{ flex: 1 }}>
                  <p style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.2em", color: "#BFA36D", textTransform: "uppercase", marginBottom: "8px" }}>{card.label}</p>
                  <h3 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(1.4rem,2vw,1.9rem)", color: "#1C1917", marginBottom: "12px", lineHeight: 1.2 }}>{card.title}</h3>
                  <p style={{ fontSize: "15px", color: "#78716C", lineHeight: 1.85, fontWeight: 300, margin: 0 }}>{card.text}</p>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#BFA36D", fontSize: "13px", fontWeight: 500 }}>
                  Mehr erfahren
      ...
      {/* ══ 4. IN 4 SCHRITTEN ════════════════════════════════════ */}
      <section style={{ backgroundColor: "#F5F1EC", padding: "96px 0" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          <div className="rv" style={{ textAlign: "center", marginBottom: "64px" }}>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "12px" }}>SO FUNKTIONIERT ES</p>
            <h2 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(2rem, 3.5vw, 3rem)", color: "#1C1917", lineHeight: 1.2, margin: 0 }}>In 4 Schritten zum Ziel.</h2>
            <div style={{ width: "48px", height: "2px", backgroundColor: "#BFA36D", margin: "20px auto 0" }} />
          </div>
          <div style={{ display: "flex", alignItems: "flex-start", gap: "0", position: "relative" }} className="rv timeline-row">
            {[
              ...
              <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", position: "relative", padding: "0 12px" }}>
                <div style={{ width: "72px", height: "72px", borderRadius: "50%", backgroundColor: "#1A3040", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px", position: "relative", zIndex: 1, flexShrink: 0 }}>
                  <span style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.1rem", color: "#BFA36D" }}>{step.num}</span>
                </div>
                {i < arr.length - 1 && (
                  <div className="timeline-arrow" style={{ position: "absolute", top: "36px", left: "calc(50% + 40px)", right: "calc(-50% + 40px)", height: "1px", backgroundColor: "#BFA36D", opacity: 0.25, zIndex: 0 }} />
                )}
                <h3 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.15rem", color: "#1C1917", marginBottom: "10px" }}>{step.title}</h3>
                <p style={{ fontSize: "13px", color: "#78716C", lineHeight: 1.8, fontWeight: 300, margin: 0 }}>{step.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ══ 5. BRAND SECTION ════════════════════════════════════ */}
      <section style={{ backgroundColor: "#1A3040", padding: "96px 0", overflow: "hidden", position: "relative" }}>
        <div style={{ position: "absolute", top: "-120px", right: "-120px", width: "600px", height: "600px", borderRadius: "50%", border: "1px solid rgba(191,163,109,0.1)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: "-100px", left: "-60px", width: "360px", height: "360px", borderRadius: "50%", border: "1px solid rgba(191,163,109,0.07)", pointerEvents: "none" }} />
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }} className="brand-grid">
          <div className="rv">
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "16px" }}>PLAN A IMMOBILIEN</p>
            ...
            <div style={{ width: "48px", height: "2px", backgroundColor: "#BFA36D", marginBottom: "24px" }} />
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
              <Image src="/ali.png" alt="Ali Artun" width={52} height={52}
                style={{ width: "52px", height: "52px", borderRadius: "50%", objectFit: "cover", border: "2px solid #BFA36D" }} />
              <div>
          ...
          <div className="rv rv-d2 brand-img-col" style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative" }}>
            <div style={{ position: "absolute", width: "340px", height: "340px", borderRadius: "50%", border: "1px solid rgba(191,163,109,0.2)" }} />
            <div style={{ position: "absolute", width: "270px", height: "270px", borderRadius: "50%", backgroundColor: "rgba(191,163,109,0.05)" }} />
      ...
      <section style={{ backgroundColor: "#FEFDFB", padding: "96px 0" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto", padding: "0 24px", textAlign: "center" }}>
          <div className="rv">
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", marginBottom: "16px" }}>KOSTENFREI & UNVERBINDLICH</p>
            <h2 style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#1C1917", lineHeight: 1.2, marginBottom: "16px" }}>
              Bereit für den nächsten Schritt?
            </h2>
            <p style={{ fontSize: "16px", color: "#78716C", lineHeight: 1.85, fontWeight: 300, marginBottom: "40px" }}>
