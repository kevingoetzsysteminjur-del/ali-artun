      ...
      <div
        ...
        <div style={{ position: "absolute", top: 0, bottom: 0, left: `${pos}%`, width: "2px", backgroundColor: "#fff", transform: "translateX(-50%)", pointerEvents: "none" }}>
          ...
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: "36px", height: "36px", borderRadius: "50%", backgroundColor: "#fff", boxShadow: "0 2px 12px rgba(0,0,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="16" height="16" fill="none" stroke="#2C1A0E" strokeWidth="2" viewBox="0 0 24 24"><path d="M9 18l-6-6 6-6M15 6l6 6-6 6"/></svg>
          </div>
        </div>
        {/* Labels */}
        ...
        <div style={{ position: "absolute", top: "10px", right: "10px", padding: "4px 10px", backgroundColor: "rgba(212,160,23,0.85)", borderRadius: "50px", fontSize: "11px", fontWeight: 500, color: "#fff", letterSpacing: "0.08em", pointerEvents: "none" }}>NACHHER</div>
      </div>
      <p style={{ fontSize: "12px", color: "#A89070", textAlign: "center", margin: 0 }}>{label}</p>
    </div>
  );
}
