...
const highlights = [
  { icon: <Building2 size={22} />, text: "300+ Partnerbanken" },
  { icon: <BadgeCheck size={22} />, text: "100% unabhängig" },
  { icon: <Zap size={22} />, text: "24h Entscheidung" },
];
        ...
        >
          ...
          >
            ...
            <div className="relative space-y-5">
              <p className="text-[#C5A028] text-xs font-semibold tracking-[0.2em] uppercase">Baufinanzierung</p>
              ...
              <p className="text-stone-400 text-base leading-relaxed">
                Verbunden mit über 300 Banken – unabhängig beraten und auf Ihrer Seite.
                Von der ersten Anfrage bis zur Unterschrift.
              </p>
            </div>
          ...
          <div className="bg-white p-10 lg:p-12 flex flex-col justify-between gap-8">
            <div className="space-y-5">
              <h3 className="font-heading text-2xl font-bold text-stone-900">In 3 Schritten zur Finanzierung</h3>
              <div className="space-y-4">
                {[
                  { num: "1", title: "Gespräch", desc: "Situation & Wünsche erfassen" },
                  { num: "2", title: "Vergleich", desc: "Beste Angebote aus 300+ Banken" },
                  { num: "3", title: "Abschluss", desc: "Sicherung Ihrer Finanzierung" },
                ].map((step) => (
