  ...
  return (
    <div style={{
      ...
      <div style={{ width: "32px", height: "32px", borderRadius: "50%", backgroundColor: "#1B3A4B", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        <svg width="14" height="14" fill="none" stroke="#C8A96E" strokeWidth="2" viewBox="0 0 24 24"><path d="M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"/></svg>
      </div>
      <div>
        <p style={{ fontSize: "11px", fontWeight: 500, color: "#C8A96E", margin: "0 0 3px", letterSpacing: "0.05em" }}>PLAN A IMMOBILIEN</p>
        <p style={{ fontSize: "12px", color: "#374151", margin: 0, lineHeight: 1.5, fontWeight: 300 }}>{text}</p>
      </div>
