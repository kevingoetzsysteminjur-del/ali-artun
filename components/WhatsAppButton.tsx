    ...
    <>
      ...
      <a
        ...
        onMouseEnter={(e) => {
          ...
          (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 6px 22px rgba(37, 211, 102, 0.5)";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)";
          (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 4px 15px rgba(37, 211, 102, 0.3)";
        }}
      >
        {/* Pulse ring */}
        <span
