...
export default function ArtikelLayout({ kategorie, kategorieColor, titel, datum, lesezeit, children, weitereArtikel }: ArtikelLayoutProps) {
  return (
    <div style={{ backgroundColor: "#FAFAF8", minHeight: "100vh" }}>
      {/* Breadcrumb + Back */}
      <div style={{ backgroundColor: "#FAF8F4", borderBottom: "1px solid rgba(201,169,110,0.15)", padding: "0 24px" }}>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <header style={{ marginBottom: "48px" }}>
          ...
          <div style={{ width: "60px", height: "2px", background: "linear-gradient(90deg, #C9A96E, #A6894D)" }} />
        </header>
        ...
        {/* CTA Box */}
        <div style={{ marginTop: "56px", padding: "36px 40px", border: "1px solid rgba(201,169,110,0.3)", backgroundColor: "#FAF8F4", borderLeft: "4px solid #C9A96E" }}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: "11px", letterSpacing: "0.2em", textTransform: "uppercase", color: "#C9A96E", marginBottom: "10px" }}>Kostenlose Beratung</p>
          ...
          <div style={{ marginTop: "56px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "16px" }}>
              {weitereArtikel.map(a => (
                <Link key={a.slug} href={`/ratgeber/${a.slug}`} style={{ textDecoration: "none", display: "block", padding: "20px", border: "1px solid rgba(201,169,110,0.2)", backgroundColor: "#fff", transition: "border-color 0.2s" }}>
                  <span style={{ fontFamily: "var(--font-body)", fontSize: "10px", letterSpacing: "0.15em", textTransform: "uppercase", color: "#C9A96E", display: "block", marginBottom: "8px" }}>{a.kategorie}</span>
