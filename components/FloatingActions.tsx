...
function KontaktPanel({ onClose }: { onClose: () => void }) {
  ...
  const inp: React.CSSProperties = { width: "100%", padding: "11px 14px", border: "1px solid #E8E0D8", borderRadius: "8px", fontSize: "14px", color: "#1C1917", outline: "none", fontFamily: "var(--font-outfit, sans-serif)", fontWeight: 300, backgroundColor: "#FEFDFB", boxSizing: "border-box" as const };
  const lbl: React.CSSProperties = { fontSize: "11px", fontWeight: 500, letterSpacing: "0.1em", textTransform: "uppercase", color: "#78716C", display: "block", marginBottom: "5px" };

  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 10000, display: "flex", justifyContent: "flex-end" }}
      onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div style={{ backgroundColor: "#fff", width: "100%", maxWidth: "440px", height: "100%", overflowY: "auto", boxShadow: "-8px 0 40px rgba(28,25,23,0.18)", display: "flex", flexDirection: "column", animation: "slideInRight 0.3s ease-out" }}>
        {/* Panel header */}
        <div style={{ backgroundColor: "#1A3040", padding: "28px 28px 24px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <p style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#BFA36D", margin: "0 0 6px" }}>PLAN A IMMOBILIEN</p>
          ...
          <div style={{ marginTop: "16px", display: "flex", gap: "16px" }}>
            ...
            <a href="https://wa.me/491736259429" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "6px", color: "#BFA36D", textDecoration: "none", fontSize: "12px" }}>
              WhatsApp
            </a>
          </div>
        </div>
        ...
        <div style={{ padding: "28px", flex: 1 }}>
          {sent ? (
            <div style={{ textAlign: "center", padding: "48px 0" }}>
              <div style={{ width: "56px", height: "56px", borderRadius: "50%", backgroundColor: "#BFA36D", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
                <svg width="24" height="20" fill="none" stroke="#fff" strokeWidth="2.5" viewBox="0 0 24 20"><polyline points="2 10 8 16 22 2"/></svg>
              </div>
              <p style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "1.3rem", color: "#1C1917", marginBottom: "10px" }}>Anfrage eingegangen!</p>
              <p style={{ fontSize: "14px", color: "#78716C", fontWeight: 300 }}>Wir melden uns innerhalb von 24 Stunden.</p>
              <button onClick={onClose} style={{ marginTop: "28px", padding: "13px 32px", background: "linear-gradient(135deg,#1A3040,#243E4F)", color: "#fff", border: "none", borderRadius: "60px", fontSize: "13px", fontWeight: 500, cursor: "pointer", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                Schließen
              </button>
            </div>
          ) : (
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer", fontSize: "12px", color: "#78716C", fontWeight: 300, lineHeight: 1.6 }}>
                ...
                <Link href="/datenschutz" style={{ color: "#BFA36D" }} target="_blank">Datenschutzerklärung</Link> zu.
              </label>
              <button type="submit"
                style={{ padding: "15px 32px", background: "linear-gradient(135deg,#1A3040,#243E4F)", color: "#fff", border: "none", borderRadius: "60px", fontSize: "13px", fontWeight: 500, cursor: "pointer", letterSpacing: "0.05em", textTransform: "uppercase", transition: "all 400ms cubic-bezier(0.4,0,0.2,1)", boxShadow: "0 4px 20px rgba(27,58,75,0.2)" }}
              ...
              <div style={{ borderTop: "1px solid #E8E0D8", paddingTop: "16px", display: "flex", gap: "12px" }}>
                <a href="tel:01736259429"
                  style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", padding: "12px", backgroundColor: "#F5F1EC", color: "#1A3040", borderRadius: "10px", textDecoration: "none", fontSize: "13px", fontWeight: 500 }}>
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: "#1A3040", borderLeft: "3px solid #BFA36D",
          border: "none", cursor: "pointer", padding: "20px 12px",
          borderRadius: "8px 0 0 8px",
          boxShadow: "-4px 0 20px rgba(26,48,64,0.2)",
          transition: "background 0.3s ease",
        }}
        onMouseEnter={e => (e.currentTarget.style.backgroundColor = "#BFA36D")}
        onMouseLeave={e => (e.currentTarget.style.backgroundColor = "#1A3040")}
      >
        <span style={{
      ...
      <div className="mobile-bottom-bar" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 900, backgroundColor: "#1A3040", display: "flex", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <button onClick={() => setPanelOpen(true)} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "10px 4px 14px", backgroundColor: "transparent", border: "none", color: "#BFA36D", fontSize: "10px", fontWeight: 500, letterSpacing: "0.05em", cursor: "pointer", gap: "4px" }}>
