...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top bar */}
      <div style={{ backgroundColor: "#1A3040", padding: "8px 0" }}>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "70px" }}>
              ...
              <div key={item.label} style={{ position: "relative" }}
                ...
                <Link href={item.href}
                  style={{
                    ...
                    fontSize: "13.5px",
                    color: (pathname === item.href || (pathname.startsWith(item.href + "/") && item.href !== "/")) ? "#1A3040" : "#374151",
                    textDecoration: "none", fontWeight: (pathname === item.href) ? 500 : 400,
                    borderBottom: (pathname === item.href || (pathname.startsWith(item.href + "/") && item.href !== "/")) ? "2px solid #BFA36D" : "2px solid transparent",
                  ...
                  <div onMouseEnter={() => openDrop(item.label)} onMouseLeave={() => closeDrop()}
                    ...
                    {item.children.map(child => (
                      <Link key={child.label} href={child.href}
                        ...
                        onMouseEnter={e => { e.currentTarget.style.backgroundColor = "#F5F1EC"; e.currentTarget.style.color = "#1A3040"; }}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <Link href="/merkzettel"
              ...
              {merkCount > 0 && (
                <span style={{ position: "absolute", top: "2px", right: "2px", width: "15px", height: "15px", borderRadius: "50%", backgroundColor: "#BFA36D", color: "#fff", fontSize: "9px", fontWeight: 600, display: "flex", alignItems: "center", justifyContent: "center" }}>{merkCount}</span>
              )}
            </Link>
            <button className="mobile-menu-btn" onClick={() => setMobileOpen(v => !v)}
              style={{ background: "none", border: "none", cursor: "pointer", padding: "8px", color: "#1A3040" }}>
              {mobileOpen
