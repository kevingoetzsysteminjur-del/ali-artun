...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: "#1B3A4B", color: "#fff" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "64px 24px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1.5fr", gap: "48px" }} className="footer-grid">
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
              ...
              <span style={{ fontFamily: "var(--font-dm-serif, serif)", fontSize: "17px", color: "#C8A96E" }}>Plan A Immobilien & Finanzierung</span>
            </div>
          ...
          {/* Col 2 – Leistungen */}
          <div>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.15em", textTransform: "uppercase", color: "#C8A96E", marginBottom: "20px" }}>Leistungen</p>
          ...
          {/* Col 3 – Unternehmen */}
          <div>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.15em", textTransform: "uppercase", color: "#C8A96E", marginBottom: "20px" }}>Unternehmen</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {[
          ...
          {/* Col 4 – Kontakt */}
          <div>
            <p style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "0.15em", textTransform: "uppercase", color: "#C8A96E", marginBottom: "20px" }}>Kontakt</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <a href="https://wa.me/491736259429"
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "13px", color: "#C8A96E", textDecoration: "none" }}>
            ...
            <div style={{ marginTop: "24px" }}>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                <button style={{ padding: "10px 16px", backgroundColor: "#C8A96E", color: "#fff", border: "none", borderRadius: "8px", fontSize: "13px", cursor: "pointer", fontWeight: 500, whiteSpace: "nowrap" }}>
                  OK
                </button>
              </div>
            </div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", marginTop: "48px", padding: "20px 0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          ...
          <p style={{ fontSize: "9px", color: "#C8A96E", opacity: 0.35, margin: 0 }}>
